...
public class BitSequence implements Serializable {
    ...
    /** Creates a new empty lib.BitSequence. */
    public BitSequence() {
        bits = new BitSet();
        numBits = 0;
        firstBitNum = 0;
    ...
    /** Creates a new lib.BitSequence with the given bit appended. */
    ...
    /** Returns a new bit sequence corresponding to the first N bits.
      ...
      * sequence's bits, so use the copy constructor on the returned lib.BitSequence if
    ...
    /** Do not make this method public. This is a utility method for
      * implementers only. lib.BitSequence is, and should remain, immutable! */
